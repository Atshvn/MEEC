    ...
    return (
        <>
            <div class="container-fluid p-0 position-relative">
                <img className=" w-100" src="../assets/images/course3.png" alt="" />
                ...
                <div className="container">
                    <div className=" row  pt-5">
                        <div className="col-md-6">
                            <h2 className="f-700 color-text">Khoá học Luyện thi TOEIC cấp tốc</h2>
                            <p>Bạn đang cần thi TOEIC cấp tốc để nộp chứng chỉ xin miễn tiếng Anh tại trường đại học, tốt nghiệp đúng hạn? 

Hay đặc biệt cần bằng TOEIC để apply công việc với mức đãi ngộ hấp dẫn. 

Hãy để Anh ngữ MEEC giúp bạn đạt được mục tiêu với khóa học TOEIC CẤP TỐC - TĂNG 200 ĐIỂM CHỈ SAU 1 THÁNG HỌC
            ...
            <div className="container pt-5 ">
                <div className="row">
                    ...
                    <div className="col-md-4">
                        ...
                        <div>
                            <Link to="course2" className="btn btn-lg bg-i w-100 mb-2">Khoá học TOEIC 0 - 500 từ mất gốc</Link>
