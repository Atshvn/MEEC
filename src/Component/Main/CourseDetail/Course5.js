    ...
    return (
        <>
            <div class="container-fluid p-0 position-relative">
                <img className=" w-100" src="../assets/images/course5.png" alt="" />
                ...
                <div className="container">
                    <div className=" row  pt-5">
                        <div className="col-md-6">
                            <h2 className="f-700 color-text">Khoá học Tiếng anh cho thiếu nhi</h2>
            ...
            <div className="container pt-5 ">
                <div className="row">
                    ...
                    <h2 className="f-700 color-text mb-4">Học phí: <span className="cl-d">6.000.000 vnd </span></h2>
