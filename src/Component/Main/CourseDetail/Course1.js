    ...
    return (
        <>
            <div class="container-fluid p-0 position-relative">
                <img className=" w-100" src="../assets/images/course2.png" alt="" />
                ...
                <div className="container">
                    <div className=" row  pt-5">
                        <div className="col-md-6">
                            <h2 className="f-700 color-text">Khoá học thành thạo 4 kĩ năng TOEIC</h2>
                            <p>Bạn là sinh viên đang lo lắng vì không đạt tiêu chuẩn TOEIC 4 kỹ năng để tốt nghiệp?
                            Bạn là người đang tìm kiếm cơ hội làm việc tại những công ty lớn nhưng trình độ tiếng anh hạn chế.
                            Khi tiếng Anh kém khiến bạn bỏ lỡ nhiều cơ hội, hãy đến Anh ngữ Master Easy Learning English, tham gia ngay Khóa học TOEIC 4 kỹ năng - Khóa học giúp bạn thành thạo
                            4 kỹ năng Nghe - Nói - Đọc - Viết trong thời gian ngắn nhất.</p>
